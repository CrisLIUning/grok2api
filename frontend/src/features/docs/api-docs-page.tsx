...
const endpoints: Record<string, EndpointDefinition> = {
  ...
  "video/generations": {
    ...
    fields: [
      ...
      { name: "operation", descriptionKey: "docs.reference.fieldVideoOperation" },
      { name: "source_request_id", descriptionKey: "docs.reference.fieldVideoSourceRequestId" },
      { name: "source_post_id", descriptionKey: "docs.reference.fieldVideoSourcePostId" },
      { name: "start_time", descriptionKey: "docs.reference.fieldVideoStartTime" },
    ],
    noteKeys: ["docs.reference.noteVideoAsync", "docs.reference.noteVideoStrict", "docs.reference.noteVideoExtension"],
    request: (model) => ({ model, operation: "extension", source_request_id: "video_D2dFBlN_tLOHyL8hQSxjpxbt", start_time: 4, prompt: "the cat suddenly jumps", duration: 8, aspect_ratio: "16:9", resolution: "720p" }),
  ...
  "video/get": {
    ...
    noteKeys: ["docs.reference.noteVideoPolling", "docs.reference.noteVideoStatus", "docs.reference.noteVideoReserve"],
    request: () => undefined,
    response: { status: "done", model: "grok-imagine-video", progress: 100, request_id: "video_example", post_id: "59d40158-a320-46eb-b651-a93084a91044", video: { url: "https://your-host/v1/media/videos/vid_example", duration: 8, respect_moderation: true } },
  },
};
